...
https://dev.axiomide.com/marketplace/christiangeorgelucas/recurrence-tools@0.1.2
...
```bash
axiom invoke christiangeorgelucas/recurrence-tools/Expand --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/recurrence-tools/0.1.2/Expand \
...
> `axiom inspect node christiangeorgelucas/recurrence-tools/Expand`.
